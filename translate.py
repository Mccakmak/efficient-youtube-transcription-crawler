...
def translate_en(filename, doc=None, attribute = 'transcription'):
    df = pd.read_csv('temp output/' + filename + ".csv")
    ...
    no_error_valid_df.to_csv('temp output/' + filename + "_translated.csv", index=False)
